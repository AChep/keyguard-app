...
const val MAX_AGENT_CALLER_NAME_LENGTH = 256
...
const val MAX_AGENT_CALLER_APP_BUNDLE_PATH_LENGTH = 512
...
fun String?.sanitizedAgentDisplayValue(maxLength: Int): String? {
    val value =
        this
            ?.takeIf { maxLength > 0 }
            ?.trim()
