...
data class EmailLeakRoute(
    ...
    companion object {
        ...
        fun checkBreachesEmailAction(
            ...
            title = translator.translate(Res.strings.email_action_check_data_breach_title),
            onClick = {
        ...
        fun checkBreachesUsernameAction(
            ...
            leading = icon(Icons.Outlined.FactCheck),
            title = translator.translate(Res.strings.username_action_check_data_breach_title),
            onClick = {
                val route = EmailLeakRoute(
                    args = Args(
                        accountId = accountId,
