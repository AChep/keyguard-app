...
@Composable
fun GpgAgentFiltersScreen() {
    val loadableState = produceGpgAgentFiltersState()
    loadableState.fold(
        ifLoading = {
            GpgAgentFiltersScreenSkeleton()
        },
        ifOk = { state ->
            GpgAgentFiltersScreenContent(state = state)
        },
    )
}
...
@Composable
private fun GpgAgentFiltersScreenSkeleton() {
    ...
    ScaffoldColumn(
        ...
        topBar = {
            LargeToolbar(
                title = {
                    Text(stringResource(Res.string.gpg_agent_filters_header_title))
                },
                navigationIcon = {
                    NavigationIcon()
                },
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun GpgAgentFiltersScreenContent(
    ...
    ScaffoldColumn(
        ...
        Text(
            ...
            text = stringResource(Res.string.gpg_agent_filters_note_save_to_apply),
