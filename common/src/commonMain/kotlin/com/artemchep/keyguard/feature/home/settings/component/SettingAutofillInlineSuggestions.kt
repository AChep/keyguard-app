...
fun settingAutofillInlineSuggestionsProvider(
    ...
    getAutofillInlineSuggestions = koinScope.get(),
    putAutofillInlineSuggestions = koinScope.get(),
...
private fun SettingAutofillInlineSuggestions(
    ...
    LocalSettingPaneComponents.current.KgSwitch(
        icon = null,
        title = stringResource(Res.string.pref_item_autofill_inline_suggestions_title),
