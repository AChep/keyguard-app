//! Best-effort caller identity extraction for GPG agent requests.
//!
//! The Assuan protocol itself does not carry trustworthy information
//! about the requesting process. On Unix we can derive the peer
//! PID/UID/GID from the connected Unix domain socket and enrich it
//! with best-effort process/app information.

use crate::ipc::messages::CallerIdentity;
use common_gpg_agent_rust::unix_caller_identity::{
