...
public enum class NativeCryptoCapability(
    ...
    AES(1L shl 6),
    STREAMING(1L shl 7),
    KDBX_ARGON2(1L shl 8),
    STREAM_CIPHER_XOR_AT_OFFSET(1L shl 9),
    TWOFISH_CBC_PKCS7(1L shl 10),
    RSA_OAEP(1L shl 11),
    RSA_KEY_FORMATS(1L shl 12),
    SSH_AGENT_TCP_CHACHA20_POLY1305(1L shl 13),
    SSH_KEYS(1L shl 14),
    SSH_AGENT_SIGNING(1L shl 15),
    SSH_PRIVATE_KEY_IMPORT(1L shl 16),
    OPENPGP_READ(1L shl 17),
    OPENPGP_WRITE(1L shl 18),
    OPENPGP_MUTATION_AGENT(1L shl 19),
    AES_CBC_HMAC_SHA256(1L shl 20),
    AES_CBC_HMAC_SHA256_FAST_PATH(1L shl 21),
    AES_CBC_HMAC_SHA256_STREAMING(1L shl 22),
    RNG_FAST_PATH(1L shl 23),
}
