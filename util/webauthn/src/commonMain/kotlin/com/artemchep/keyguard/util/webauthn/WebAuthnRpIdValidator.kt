...
class WebAuthnRpIdValidator(
    private val domainLookup: WebAuthnDomainLookup,
    httpClient: HttpClient,
) {
    private val relatedOrigins = WebAuthnRelatedOrigins(domainLookup, httpClient)
    ...
    suspend fun resolveAndValidateRpId(
        rpId: String?,
        origin: String,
    ): String = resolveRpId(rpId, origin).also {
        requireRpMatchesOrigin(it, origin)
    }
