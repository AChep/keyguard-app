package com.artemchep.keyguard.wear.crypto

import androidx.test.ext.junit.runners.AndroidJUnit4
import androidx.test.filters.SmallTest
import com.artemchep.keyguard.nativecrypto.NativeCrypto
import com.artemchep.keyguard.nativecrypto.NativeCryptoCapability
...
class NativeCryptoLoadSmokeTest {
    ...
    fun loadsNativeLibraryAndExecutesSmokeCoverage() {
        ...
        assertArrayEquals(
            SHA256_ABC,
            PlatformCryptoPrimitives().sha256("abc".encodeToByteArray()),
        )
        ...
        try {
            ...
            val signed = NativeCrypto.ssh.sign(
                ...
                data = "native-crypto-wear-smoke".encodeToByteArray(),
                flags = 0,
            )
